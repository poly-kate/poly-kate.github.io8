                                    ...
                                    <tr>
                                        <td width="492" valign="top" height="106">
                                            ...
                                            <div style="margin-left:1px; margin-top:2px; margin-right:10px "><br>
                                                ...
                                                <select required form="order-form" size="3" name="hero">
                                                    <option value="100">прокат</option>
                                                    <option value="500">продажа</option>
                                                    <option value="2100">лизинг</option>
                                                </select>
                                                ...
                                                <tr>
                                                    <td valign="top" height="232" width="248">
                                                        ...
                                                        <div style="margin-top:10px; margin-left:6px "><img src="../images/pointer.gif"><img src="../images/spacer.gif" width="3">
                                                            <input type="checkbox" value="50"><label>Кожаный салон</label><br>
                                                            <input type="checkbox" value="30"><label>Подогрев сидений</label><br>
                                                            <input type="checkbox" value="100"><label>Люк</label><br>
                                                        </div>
